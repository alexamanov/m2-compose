...
class Interceptor extends \Magento\Directory\Model\ResourceModel\Country\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function loadByStore($store = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('loadByStore', func_get_args(), $pluginInfo) : parent::loadByStore($store);
    }
    ...
    public function getItemById($countryId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getItemById', func_get_args(), $pluginInfo) : parent::getItemById($countryId);
    }
    ...
    public function addCountryCodeFilter($countryCode, $iso = ['iso3', 'iso2'])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCountryCodeFilter', func_get_args(), $pluginInfo) : parent::addCountryCodeFilter($countryCode, $iso);
    }
    ...
    public function addCountryIdFilter($countryId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCountryIdFilter', func_get_args(), $pluginInfo) : parent::addCountryIdFilter($countryId);
    }
    ...
    public function toOptionArray($emptyLabel = ' ')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('toOptionArray', func_get_args(), $pluginInfo) : parent::toOptionArray($emptyLabel);
    }
    ...
    public function setForegroundCountries($foregroundCountries)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setForegroundCountries', func_get_args(), $pluginInfo) : parent::setForegroundCountries($foregroundCountries);
    }
    ...
    public function getCountriesWithRequiredStates()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCountriesWithRequiredStates', func_get_args(), $pluginInfo) : parent::getCountriesWithRequiredStates();
    }
