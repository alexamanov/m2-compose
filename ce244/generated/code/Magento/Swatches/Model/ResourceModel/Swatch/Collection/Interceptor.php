...
class Interceptor extends \Magento\Swatches\Model\ResourceModel\Swatch\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByOptionsIds');
        return $pluginInfo ? $this->___callPlugins('addFilterByOptionsIds', func_get_args(), $pluginInfo) : parent::addFilterByOptionsIds($optionsIds);
    }
