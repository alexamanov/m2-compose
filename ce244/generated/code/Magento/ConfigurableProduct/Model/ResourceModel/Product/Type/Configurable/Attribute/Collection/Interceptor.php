...
class Interceptor extends \Magento\ConfigurableProduct\Model\ResourceModel\Product\Type\Configurable\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function orderByPosition($dir = 'ASC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('orderByPosition', func_get_args(), $pluginInfo) : parent::orderByPosition($dir);
    }
    ...
    public function _addAssociatedProductFilters()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_addAssociatedProductFilters', func_get_args(), $pluginInfo) : parent::_addAssociatedProductFilters();
    }
